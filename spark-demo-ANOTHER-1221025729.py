...
args = {
    "project_id": "spark-demo-ANOTHER-1221025729",
}

dag = DAG(
    "spark-demo-ANOTHER-1221025729",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using spark-demo-ANOTHER.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demo-ANOTHER-1221025729",
